...
class Constants
{
    ...
    //service time distribution corrsponding to call subject
    final static double[][] SERVICE_TIME = {
            {1.2,  3.75, 2.05}, //INFORMATION
            {2.25, 8.6,  2.95}, //RESERVATION
            {1.2,  5.8,  1.9 }  //CHANGE
    };
    //after call work time distribution corrsponding to call subject
    final static double[][] AFTER_CALL_TIME = {
            {0.05, 0.10}, //INFORMATION
            {0.5,  0.8 }, //RESERVATION
            {0.4,  0.6 }  //CHANGE
    };
    //arrival rate of regular customers
    final static double[] REGULAR_ARRIVAL_RATE = {
        ...
        //arrival rate of cardholder customers
    ...
    //tolerated wait time distribution corresponding to different customer type
    final static double[][] TOLERATED_WAIT_TIME = {
            {12.0, 30.0}, //REGULAR
            {8.0,  17.0}  //CARDHOLDER
    };
    //proportion of different service time by different types of operator
    ...
    //proportion of call type/subject
    final static double[] PROPORTION_SUBJECT = {
            0.16, //INFORMATION
            0.76, //RESERVATION
            0.08  //CHANGE
    };
    //staff change time sequence correspondin to the time from 7am to 7pm
    final static double[] STAFF_CHANGE_TIME_SEQ = {
            ...
            600.0, //5  PM
            660.0, //6  PM
            -1.0   //reporesent the END of time
    };
